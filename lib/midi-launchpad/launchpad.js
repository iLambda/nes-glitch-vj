 ...
 */
var Launchpad = function(portin, portout, initAnimation) {
    ...
    this.init = function() {
        ...
        this.output.openPort(portout);
        this.input.openPort(portin);
        ...
        console.log("running launchpad: in("+this.input.getPortName(portin)+") out("+this.output.getPortName(portout)+")");

        this.initialize();
    };

    console.log("setting up Launchpad on ports: (in:" + portin + ",out:" + portout + ")");
    this.init();
...
exports.connect = function(portin, portout, initAnimation) {
    return new Launchpad(portin, portout, initAnimation);
};
